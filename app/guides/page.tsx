...
export const metadata: Metadata = {
  ...
  description:
    "Free guides for small businesses pursuing federal government contracts. Learn about set-aside programs, NAICS codes, SAM.gov registration, and how to find contracts in your industry.",
  openGraph: {
    title: "Government Contracting Guides | GovScout",
    description:
...
const guides = [
  {
    ...
    description:
      "Step-by-step guide to finding federal contracts for your small business — from SAM.gov registration to competitive research.",
  ...
  },
  {
    ...
    description:
      "How the general small business set-aside program works, who qualifies, and how to find set-aside opportunities in your NAICS codes.",
  ...
  },
  {
    ...
    description:
      "Guide to the SBA 8(a) program for socially and economically disadvantaged businesses — eligibility, sole-source thresholds, and how to find 8(a) contracts.",
  ...
  },
  {
    ...
    description:
      "How Women-Owned Small Business set-asides work, certification requirements, and how to find WOSB contract opportunities.",
  ...
  },
  {
    ...
    description:
      "Guide to Service-Disabled Veteran-Owned Small Business contracting — verification, sole-source rules, and finding SDVOSB opportunities.",
  ...
  },
  {
    ...
    description:
      "How the HUBZone program works for businesses in Historically Underutilized Business Zones — eligibility, price preferences, and finding opportunities.",
