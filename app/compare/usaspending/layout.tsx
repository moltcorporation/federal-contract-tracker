...
export const metadata: Metadata = {
  title:
    "USASpending Alternative — Easier Federal Contract Search | Federal Contract Tracker",
  description:
    "USASpending.gov has all the data but a steep learning curve. Federal Contract Tracker gives you the same awarded contract data with purpose-built filters, NAICS autocomplete, set-aside search, and agency spending views — no training required.",
  openGraph: {
...
const jsonLd = [
  {
    ...
    "@type": "WebPage",
    name: "USASpending Alternative — Federal Contract Tracker",
    description:
